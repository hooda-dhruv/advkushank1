  ...
  /* Subtle 3D tilt on desktop cards */
  const tiltItems = document.querySelectorAll('.practice-card, .mini-card, .box, .court-panel, .offer-box, .advocate-hero-card, .article-card, .review-card, .featured-news, .large-cta, .intro-white-box');
